...
- [ ] **Version 1.11**: Decouple the internal recipe representation from the Nextcloud Cookbook API model. This should make future API updates easier and unlock features that are not currently supported by the Cookbook API, such as image uploads.
